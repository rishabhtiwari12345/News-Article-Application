...
const formSchema = z.object({
  ...
  email: z.string().email({ message: 'Invalid email address' }), // Updated validation
  password: z
    .string()
...
function SignUpForm() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      username: '',
      email: '', // Corrected assignment
      password: '', // Corrected assignment
    },
  });
  ...
  return (
    <div className="min-h-screen mt-20">
      <div className="flex p-3 max-w-3xl sm:max-w-5xl mx-auto flex-col flex-col md:flex-row md:items-center gap-5">
        {/* Left */}
